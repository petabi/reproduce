...
KafkaProducer::KafkaProducer(shared_ptr<Config> _conf) : conf(_conf)
{
...
FileProducer::FileProducer(shared_ptr<Config> _conf) : conf(_conf)
{
...
NullProducer::NullProducer(shared_ptr<Config> _conf) : conf(_conf) {}
