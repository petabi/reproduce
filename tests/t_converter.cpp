...
TEST(test_converter, test_vlan_converter)
{
  std::vector<unsigned char> mypkt1 = {
      0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
      0x39, 0x00, 0x00, 0x00, 0x39, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
      0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x81, 0x00, 0x00, 0x20, 0x08,
      0x00, 0x45, 0x00, 0x00, 0x2B, 0x00, 0x01, 0x00, 0x00, 0x40, 0x06,
      0x7C, 0xCA, 0x7F, 0x00, 0x00, 0x01, 0x7F, 0x00, 0x00, 0x01, 0x00,
      0x14, 0x00, 0x50, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
      0x50, 0x02, 0x20, 0x00, 0xCD, 0x16, 0x00, 0x00, 0x61, 0x62, 0x63};

  std::vector<std::string> signatures = {"abc"};
  std::string sample_file = "mysample.rules";
  std::ofstream sample_out(sample_file);
  for (const auto& sig : signatures) {
    sample_out << sig << std::endl;
